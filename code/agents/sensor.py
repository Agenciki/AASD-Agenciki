...
class SensorAgent(spade.agent.Agent):
    def __init__(self, jid, password, analyzer_jid,coords,test_mode=False, *args, **kwargs):
    ...
    class HandleDefenseRequest(spade.behaviour.CyclicBehaviour):
        async def run(self):
            ...
            if msg:
                try:
                    ...
                    print(f"[Sensor] Potwierdzenie sukcesu wysłane do nadawcy.")
    ...
    async def setup(self):
        ...
        # Filtr: odbieraj tylko wiadomości typu REQUEST
        template = Template()
